...
import net.livecar.nuttyworks.destinations_farmer.plugin.MC_1_13_R1;
import net.livecar.nuttyworks.destinations_farmer.plugin.Farmer_Commands;
import net.livecar.nuttyworks.destinations_farmer.plugin.Farmer_Plugin;
...
public class Destinations_Farmer {
    ...
    public Farmer_Plugin                  getFarmerPlugin       = null;
    ...
    public Destinations_Farmer() {
        this.getFarmerPlugin = new Farmer_Plugin(this);
        DestinationsPlugin.Instance.getPluginManager.registerPlugin(getFarmerPlugin);
        DestinationsPlugin.Instance.getCommandManager.registerCommandClass(Farmer_Commands.class);
        ...
        if (Bukkit.getServer().getClass().getPackage().getName().endsWith("v1_8_R3")) {
            ...
            getProcessingClass = new MC_1_13_R1();
            Version = 11300;
